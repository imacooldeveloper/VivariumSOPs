...
struct MainTabBarView: View {
    ...
    var body: some View {
        if userAccountType.lowercased() == "husbandry" {
            ...
            // Admin and other users - Add home tab using HusbandryUserProfileView for admins
            TabView(selection: $selectedTab) {
                // Only show the Home tab for admins
                ...
                .tag(userAccountType.lowercased() == "admin" ? 1 : 0)
                ...
                .tag(userAccountType.lowercased() == "admin" ? 2 : 1)
                ...
                .tag(userAccountType.lowercased() == "admin" ? 3 : 2)
                ...
                .tag(userAccountType.lowercased() == "admin" ? 4 : 3)
            }
            .onChange(of: selectedTab) { _ in
                navigationHandler.path.removeLast(navigationHandler.path.count)
            }
